...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    fruits();
    fruit1=createSprite(70,200,40,40)
    fruit1.addImage(fruit1)
    fruit1.scale=0.1
    fruit2=createSprite(70,200,40,40)
    fruit2.addImage(fruit2)
    fruit2.scale=0.1
    fruit3=createSprite(70,200,40,40)
    fruit3.addImage(fruit3)
    fruit3.scale=0.1
    fruit4.createSprite(70,200,40,40)
     fruit4.addImage(fruit4)
     fruit4.scale=0.1
    Monster();
    Monster=createSprite(80,200,50,50)
